...
class LlamaForCausalLM(BaseLM): #LlamaPreTrainedModel
    ...
    def __init__(self, config):
        ...
        if args.model == 'llama-7b':
            ...
            self.tokenizer = LlamaTokenizer.from_pretrained("decapoda-research/llama-30b-hf")
 
        elif args.model == 'llama-65b':
            self.tokenizer = LlamaTokenizer.from_pretrained("decapoda-research/llama-65b-hf")
