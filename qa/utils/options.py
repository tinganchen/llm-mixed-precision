...
MODEL = 'gpt2' # 'facebook/opt-125m', 'gpt2', 'llama-7b'
METHOD = 'all' # 'wikitext', 'ptb', 'c4', 'lambada'
QMETHOD = 'mpl' # 'rtn' ('uniform'), 'gptq', 'smoothquant', 'ptqvit'
...
parser.add_argument('--attack_dir', type = str, default = f'../../llm_experiment/{MODEL.split("/")[-1]}/{METHOD}/{INDEX}/', help = 'The directory where the summaries will be stored.') # 'experiments/'
...
parser.add_argument('--fix_bitW', type = str, default = FIXED_BITW, help = 'Fixed weight bitwidth.') # None
parser.add_argument('--fix_abitW', type = str, default = FIXED_ABITW, help = 'Fixed activation bitwidth.') # None

parser.add_argument('--img_size', type = int, default = 32, help = 'Image size.') # None

parser.add_argument('--target_model', type = str, default = 'GPT2LMHeadModel', help = 'The target model.') # 'GPT2LMHeadModel', 'OPTClass', 'LlamaForCausalLM'
...
#=============
parser.add_argument('--model_args', type = str, default = None, help = 'The target model.')
parser.add_argument("--tasks", type=str, default='lambada_openai,hellaswag')
